...
<body>
    <nav class="navbar">
        <div class="container">
            ...
            <div class="desktop-menu">
                ...
                <!-- Produk Dropdown -->
                <div class="dropdown">
                    <a href="#produk" class="nav-link dropbtn <?php echo e(request()->is('produk*') ? 'active' : ''); ?>">
                        Produk 
    ...
    <section class="hero">
        <div class="hero-background">
            <div class="slide active" style="background-image: url('<?php echo e(asset('images/slide1.jpg')); ?>')"></div>
            <div class="slide" style="background-image: url('<?php echo e(asset('images/slide2.jpg')); ?>')"></div>
            <div class="slide" style="background-image: url('<?php echo e(asset('images/slide3.jpg')); ?>')"></div>
...
<section class="catalog-section">
    ...
    <div class="catalog-grid">
        ...
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan1.png')); ?>" alt="Bunga Papan Selamat & Sukses" class="catalog-image">
        ...
        <!-- Product 2 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan2.png')); ?>" alt="Bunga Papan Selamat" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 3 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan.png')); ?>" alt="Bunga Papan Selamat" class="catalog-image">
            <div class="catalog-info">
                <h3>Bunga Papan Selamat</h3>
                <div class="price-action">
                    <span class="catalog-price">Rp 1.800.000</span>
        ...
        <!-- Product 4 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan4.png')); ?>" alt="Standing Flower" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 5 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan5.png')); ?>" alt="Bunga Papan Congratulations" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 6 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-papan/bungapapan6.png')); ?>" alt="Bunga Papan Duka Cita" class="catalog-image">
            <div class="catalog-info">
...
<section class="catalog-section">
    ...
    <div class="catalog-grid">
        <!-- Product 1 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket1.png')); ?>" alt="Buket Mawar Merah" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 2 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket2.png')); ?>" alt="Buket Baby Breath" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 3 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket3.png')); ?>" alt="Buket Tulip" class="catalog-image">
            <div class="catalog-info">
                <h3>Buket Tulip</h3>
                <div class="price-action">
        ...
        <!-- Product 4 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket4.png')); ?>" alt="Buket Lavender" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 5 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket5.png')); ?>" alt="Buket Gardenia" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 6 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-buket/buket6.png')); ?>" alt="Buket Mixed Flowers" class="catalog-image">
            <div class="catalog-info">
...
<section class="catalog-section" style="background-color: #f5f5f5;">
    ...
    <div class="catalog-grid">
        <!-- Product 1 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja1.png')); ?>" alt="Rangkaian Meja Mawar" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 2 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja2.png')); ?>" alt="Rangkaian Meja Anggrek" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 3 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja3.png')); ?>" alt="Rangkaian Meja Lily" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 4 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja4.png')); ?>" alt="Rangkaian Meja Mini" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 5 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja5.png')); ?>" alt="Rangkaian Meja Modern" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 6 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/bunga-meja/meja6.png')); ?>" alt="Rangkaian Meja Klasik" class="catalog-image">
            <div class="catalog-info">
...
<section class="catalog-section">
    ...
    <div class="catalog-grid">
        <!-- Product 1 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing1.png')); ?>" alt="Standing Flower Mawar" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 2 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing2.png')); ?>" alt="Standing Flower Anggrek" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 3 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing3.png')); ?>" alt="Standing Flower Lily" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 4 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing4.png')); ?>" alt="Standing Flower Premium" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 5 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing5.png')); ?>" alt="Standing Flower Minimalis" class="catalog-image">
            <div class="catalog-info">
        ...
        <!-- Product 6 -->
        <div class="catalog-card">
            <img src="<?php echo e(asset('images/standing-flower/standing6.png')); ?>" alt="Standing Flower Luxury" class="catalog-image">
            <div class="catalog-info">
    ...
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <div class="payment-methods">
                <img src="<?php echo e(asset('images/bca.png')); ?>" alt="BCA" class="payment-icon">
                <img src="<?php echo e(asset('images/gopay.png')); ?>" alt="Gopay" class="payment-icon">
                <img src="<?php echo e(asset('images/dana.png')); ?>" alt="DANA" class="payment-icon">
            </div>
...
</html><?php /**PATH C:\laragon\www\Rikoflorist\resources\views/home.blade.php ENDPATH**/ ?>